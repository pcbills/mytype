...
const DEFAULT_ENTRIES = [
  // ===== Pok\u00e9mon =====
  {
    ...
    text: 'Pikachu is one of the most famous Pok\u00e9mon in the world. This small, yellow, mouse-like creature is known for its ability to generate powerful electric shocks from the red pouches on its cheeks. Pikachu is an Electric-type Pok\u00e9mon that is loved by fans of all ages.'
  },
  {
    ...
    text: 'Charizard is a powerful Fire and Flying-type Pok\u00e9mon that evolves from Charmeleon. It is the final evolution of Charmander, one of the original starter Pok\u00e9mon from the Kanto region Its fire burns hotter when it has experienced tough battles.'
  },
  {
    id: 'pokemon-eevee',
    category: 'pokemon',
    ...
    text: 'Eevee is a unique Normal-type Pok\u00e9mon known for its unstable genetic code. This special trait allows Eevee to evolve into many different Pok\u00e9mon. Eevee can become Vaporeon, Jolteon, Flareon, Espeon, Umbreon, Leafeon, Glaceon, or Sylveon. Its fluffy brown fur and big eyes make it one of the cutest Pok\u00e9mon around.'
  },
  {
    id: 'pokemon-mewtwo',
    category: 'pokemon',
  ...
  // ===== Animals =====
  {
    ...
    text: 'The red panda is a small mammal that lives in the forests of the eastern Himalayas and southwestern China. Despite its name, the red panda is not closely related to the giant panda. Red pandas spend most of their time in trees and are excellent climbers. They mainly eat bamboo but also enjoy fruits, berries, and insects.'
  },
  {
    id: 'animals-octopus',
    category: 'animals',
  ...
  },
  {
    ...
    text: 'Dolphins are highly intelligent marine mammals. They are known for their playful behavior. Dolphins use a special ability called echolocation to find food and navigate through dark or murky water by sending out clicking sounds and listening for the echoes. Dolphins are also known for being friendly toward humans and have been observed helping swimmers in trouble.'
  },
  ...
  // ===== Video Games =====
  {
    ...
    text: 'Minecraft is one of the best-selling video games of all time, with over 300 million copies sold worldwide. In this sandbox game, players explore a blocky, procedurally generated 3D world where they can mine resources, craft tools, and build structures. Minecraft was created by Markus Persson and was first released in 2011. The game has become a global phenomenon used not only for entertainment but also for education.'
  },
  {
  ...
  },
  {
    ...
    text: 'Fortnite is a popular battle royale game developed by Epic Games that took the gaming world by storm when it was released in 2017. In the main Battle Royale mode, 100 players drop onto an island and compete to be the last player standing. Fortnite is known for its colorful art style, fun dance emotes, and frequent collaborations with movies, music artists, and other games.'
  },
  ...
  // ===== Science =====
  {
    ...
    text: 'Our solar system is made up of the Sun and everything that orbits around it, including eight planets, dwarf planets, moons, asteroids, and comets. The four inner planets, Mercury, Venus, Earth, and Mars, are rocky worlds, while the four outer planets, Jupiter, Saturn, Uranus, and Neptune, are much larger and made mostly of gas and ice. The Sun contains more than 99 percent of all the mass in the solar system and provides the light and heat that makes life possible on Earth.'
  },
  {
  ...
  },
  {
    ...
    text: 'Dinosaurs were a group of reptiles that ruled the Earth for over 160 million years before going extinct about 66 million years ago. They came in all shapes and sizes, from the massive Argentinosaurus, which was over 100 feet long, to the tiny Microraptor, which was about the size of a crow.'
  },
  {
